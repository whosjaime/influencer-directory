...
GENRE_KEYWORDS = {
    ...
    "Beauty": {
        "beauty", "makeup", "skincare", "cosmetics", "get ready with me", "grwm",
    },
    "Fashion": {
        "fashion", "outfit", "clothing", "streetwear", "style", "haul",
    },
    "Fitness": {
        "fitness", "workout", "gym", "bodybuilding", "running", "training", "lifting",
    },
    "Health": {
        "health", "wellness", "nutrition", "medical", "doctor", "mental health",
    },
    "Food": {
        "food", "cooking", "recipe", "chef", "restaurant", "baking", "meal prep",
    },
    "Travel": {
        "travel", "travelling", "traveling", "vacation", "hotel", "flight", "tourism",
    },
    "Sports": {
    ...
    "Automotive": {
        "car", "cars", "automotive", "supercar", "truck", "motorcycle", "racing",
    },
    "Family": {
        "family", "family vlog", "mom", "dad", "parenting", "kids", "children",
    },
    "Comedy": {
        "comedy", "funny", "skit", "parody", "prank", "comedian", "humor",
    },
    "Entertainment": {
        "entertainment", "challenge", "challenges", "vlog", "reaction", "storytime",
        "creator", "youtube", "viral",
    },
    "Education": {
        "education", "educational", "tutorial", "learn", "explained", "science",
        "history", "study",
    },
    "Music": {
        "music", "musician", "singer", "rapper", "producer", "song", "album",
    },
    "Home": {
        "home", "interior", "decor", "renovation", "diy", "woodworking", "cleaning",
    },
    "Outdoors": {
        "outdoors", "camping", "hiking", "fishing", "hunting", "survival",
    },
    "Pets": {
...
TAG_KEYWORDS = {
    ...
    "Reactions": {"reaction", "reacts", "reacting"},
...
def classify_creator(video: VideoRecord, channel: ChannelRecord | None) -> tuple[str, list[str]]:
    ...
    # YouTube topic URLs often carry very strong high-level genre labels.
